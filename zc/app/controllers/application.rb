...
class ApplicationController < ActionController::Base
  ...
  def user_role
    ...
    elsif (self.controller_name == 'should_charge' or self.controller_name == 'should_refund' or self.controller_name == 'consult_att') and session[:user_code_2]!=nil and session[:user_code]==nil
